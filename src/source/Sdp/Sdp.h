...
#define MAX_SDP_SESSION_BANDWIDTH_COUNT        10
#define MAX_SDP_SESSION_TIME_DESCRIPTION_COUNT 10
#define MAX_SDP_SESSION_TIMEZONE_COUNT         10
/**
...
#define MAX_SDP_MEDIA_BANDWIDTH_COUNT 10
